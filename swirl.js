...
(function (global) {
  ...
  var FRAG = [
    ...
    "  float core = smoothstep(1.1, 0.0, edge);",
    "  col += vec3(0.9, 0.82, 0.95) * core * 0.35 * (1.0 - u_zoom);",
    "",
    "  // radial reveal blooming out from the centre",
    "  float rad = u_reveal * 1.7;",
    "  float revealMask = smoothstep(rad, rad - 0.55, edge);",
    "",
    "  // ephemeral falloff at the rim + whole-field dissolve",
    "  float rim = smoothstep(1.55, 0.35, edge);",
